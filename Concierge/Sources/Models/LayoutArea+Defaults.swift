...
extension LayoutArea {
    ...
    static let top = LayoutArea(titleKey: LayoutArea.keyTop, activeKey: .t, modifiers: [.shift, .control], rect: NSRect(x: 0, y: 0, width: 1, height: 0.5))
    static let bottom = LayoutArea(titleKey: LayoutArea.keyBottom, activeKey: .b, modifiers: [.shift, .control], rect: NSRect(x: 0, y: 0.5, width: 1, height: 0.5))
    static let topLeft = LayoutArea(titleKey: LayoutArea.keyTopLeft, activeKey: .one, modifiers: [.shift, .control], rect: NSRect(x: 0, y: 0, width: 0.5, height: 0.5))
    static let topRight = LayoutArea(titleKey: LayoutArea.keyTopRight, activeKey: .two, modifiers: [.shift, .control], rect: NSRect(x: 0.5, y: 0, width: 0.5, height: 0.5))
    static let bottomLeft = LayoutArea(titleKey: LayoutArea.keyBottomLeft, activeKey: .three, modifiers: [.shift, .control], rect: NSRect(x: 0, y: 0.5, width: 0.5, height: 0.5))
    static let bottomRight = LayoutArea(titleKey: LayoutArea.keyBottomRight, activeKey: .four, modifiers: [.shift, .control], rect: NSRect(x: 0.5, y: 0.5, width: 0.5, height: 0.5))
